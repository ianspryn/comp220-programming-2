...
public class ThreadSim implements Runnable{
    ...
    static float[] targetWeightLeft = {10.5f,12.75f,14.5f,16.5f,20.0f};
    static float[] targetWeightRight = {10.5f,12.75f,14.5f,16.5f};
                                                     ...
                                                     for(int x = (threads == 3) ? thread : 0; (threads == 3 && thread == x)||(threads != 3 && x < 3); x++){
                                                         ...
                                                         for(int y = (threads == 2) ? thread : 0; (threads == 2 && thread == y)||(threads != 2 && y < 2); y++){
                                                             ...
                                                             if(!fail) {
                                                                 ...
                                                                 offtotal += (left[1] - targetWeightLeft[1]) > 0 ? Math.pow(Math.abs(left[1] - targetWeightLeft[1]) + 1, 3) : Math.abs(left[1] - targetWeightLeft[1]) + 1;
